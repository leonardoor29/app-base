...
export default function Login({ navigation }) {
  ...
  async function Login () {
    if (FormValues.usuario && FormValues.senha) {
      ...
      AsyncStorage.setItem('@NameUser', "Usuario!!");
              ...
              <BoxForm style={{  marginBottom: 0 }} >
                ...
                { keyboard ? null :  
                    <View style={styles.footer}>
                        ...
                        <View style={styles.rodapeMeio}><Text style={styles.txtRodape}>Busca de informações de paises</Text></View>
                        <View style={styles.RodapeLine}><View></View></View>
                        </View>

                        <View><Text style={styles.txtRodape2}>Powered by Leonardo Rodrigues</Text></View>
                    </View>
                }        
            </Container>
